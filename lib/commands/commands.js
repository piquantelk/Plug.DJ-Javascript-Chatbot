...
commandsCommand = (function(_super) {
  ...
  function commandsCommand() {
    _ref = commandsCommand.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  commandsCommand.prototype.functionality = function() {
    var allowedUserLevels, c, cc, cmd, msg, user, _i, _j, _len, _len1, _ref1, _ref2;
    allowedUserLevels = [];
    ...
    for (_i = 0, _len = cmds.length; _i < _len; _i++) {
      cmd = cmds[_i];
      c = new cmd('');
      if (_ref1 = c.rankPrivelege, __indexOf.call(allowedUserLevels, _ref1) >= 0) {
